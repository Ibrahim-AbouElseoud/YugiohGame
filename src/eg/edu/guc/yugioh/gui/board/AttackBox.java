...
public class AttackBox extends JDialog {
	...
	JLabel comment= new JLabel("Please choose the monster you want to attack with this monster");
	
	public AttackBox(ArrayList<MonsterCard>monstersOnField ){ //self true if pick monster from own field , false if pick monster from opponent field
		...
		this.add(comment);
		JButton activate=new JButton("Attack");
		...
		activate.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				else JOptionPane.showMessageDialog(Main.getGameBoard(),"Can only selectone monster to attack!");
				monsterNames.clear();
				selectedCard=0;
				dispose();
			}
