...
public class ActionToAttack implements ActionListener{

	@Override
	public void actionPerformed(ActionEvent e) {
		MonsterCardB monsterToAttack=(MonsterCardB) e.getSource();
		Main.getGameBoard().setMonsterToStartAttack(monsterToAttack);
